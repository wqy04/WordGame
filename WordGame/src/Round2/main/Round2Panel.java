...
public class Round2Panel extends JPanel {
      private GameBlackBoard gameBlackBoard;
      private GameBox2 gameBox;
      private GamePeople2 gamePeople;
      ...
      public Round2Panel(MainFrame mainFrame){
            ...
            addComponentListener(new ComponentAdapter() {
                  ...
                  public void componentShown(ComponentEvent e) {
                        Round2Panel.this.requestFocusInWindow();
                  }
            });
      }
      ...
      public void Instantiation(MainFrame mainFrame, HelpFrame helpFrame){
            ...
            gameBox = new GameBox2(mainFrame, helpFrame);
            gamePeople = new GamePeople2();
      }
